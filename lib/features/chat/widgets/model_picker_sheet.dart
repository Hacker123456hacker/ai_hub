          ...
          ConstrainedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, i) {
                final model = OpenRouterModels.popular[i];
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          Text(model['name']!, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14.5)),
                          Text(model['provider']!, style: TextStyle(fontSize: 12.5, color: Theme.of(context).hintColor)),
                        ],
                      )),
                      if (badge.isNotEmpty) ...[
                        Container(
                          ...
                          child: Text(badge, style: const TextStyle(color: AppColors.success, fontSize: 10.5, fontWeight: FontWeight.w700)),
                        ),
